...
import com.example.spring.back.hibernate.mapper.ProductMapper;
...
public class ProductEndpoint {
    ...
    @Autowired
    public ProductEndpoint(SpringHibernateConfig springHibernateConfig) {
    ...
    public GetProductResponse getProduct(@RequestPayload GetProductRequest request) {
        ...
        response.setProduct(ProductMapper.asProductDto(springHibernateConfig.findProductByLabel().process(request.getLabel())));
        return response;
    }
    ...
    public CreateProductResponse createProduct(@RequestPayload CreateProductRequest request) {
        ...
        response.setProduct(ProductMapper.asProductDto(springHibernateConfig.createProduct().process(ProductMapper.asProductEntity(request.getProduct()))));
        return response;
    }
    ...
    public UpdateProductResponse updateProduct(@RequestPayload UpdateProductRequest request) {
        ...
        response.setProduct(ProductMapper.asProductDto(springHibernateConfig.updateProduct().process(ProductMapper.asProductEntity(request.getProduct()))));
        return response;
    }
    ...
    public DeleteProductResponse deleteProduct(@RequestPayload DeleteProductRequest request) {
        ...
        springHibernateConfig.deleteProduct().process(ProductMapper.asProductEntity(request.getProduct()));
