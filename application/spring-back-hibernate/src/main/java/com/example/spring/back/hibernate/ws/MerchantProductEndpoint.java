...
public class MerchantProductEndpoint {
    ...
    @Autowired
    public MerchantProductEndpoint(SpringHibernateConfig springHibernateConfig) {
    ...
    public AssociateMerchantProductResponse getMerchant(@RequestPayload AssociateMerchantProductRequest request) {
        ...
        com.example.models.Merchant returnedMerchant = springHibernateConfig.associateWithProduct().process(
