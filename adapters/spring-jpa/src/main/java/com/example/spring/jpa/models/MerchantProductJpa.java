...
public class MerchantProductJpa implements Serializable {
    ...
    public MerchantProductJpa(MerchantJpa merchant, ProductJpa product) {
        this.merchant = merchant;
        this.product = product;
    }

    public MerchantProductJpa(MerchantProductId id, MerchantJpa merchant, ProductJpa product) {
        this.id = id;
        this.merchant = merchant;
        this.product = product;
    }
